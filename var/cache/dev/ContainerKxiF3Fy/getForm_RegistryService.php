...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\DocType' => function () {
    return ($this->privates['App\Form\DocType'] ?? $this->privates['App\Form\DocType'] = new \App\Form\DocType());
}, 'App\\Form\\MessageType' => function () {
    return ($this->privates['App\Form\MessageType'] ?? $this->privates['App\Form\MessageType'] = new \App\Form\MessageType());
}, 'App\\Form\\SettingsType' => function () {
    return ($this->privates['App\Form\SettingsType'] ?? $this->privates['App\Form\SettingsType'] = new \App\Form\SettingsType());
}, 'App\\Form\\UpdateFileType' => function () {
    return ($this->privates['App\Form\UpdateFileType'] ?? $this->privates['App\Form\UpdateFileType'] = new \App\Form\UpdateFileType());
}, 'App\\Form\\UpdateMessageType' => function () {
    return ($this->privates['App\Form\UpdateMessageType'] ?? $this->privates['App\Form\UpdateMessageType'] = new \App\Form\UpdateMessageType());
