...
$a->setNamespace('sf_orm_default_c509079fbfe774a3fe5d9970468d13877b8fe256b54fafecfa1b5a4ed9bc7849');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_c509079fbfe774a3fe5d9970468d13877b8fe256b54fafecfa1b5a4ed9bc7849');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_c509079fbfe774a3fe5d9970468d13877b8fe256b54fafecfa1b5a4ed9bc7849');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\FileRepository' => function () {
    return ($this->privates['App\Repository\FileRepository'] ?? $this->load(__DIR__.'/getFileRepositoryService.php'));
}, 'App\\Repository\\MessageRepository' => function () {
    return ($this->privates['App\Repository\MessageRepository'] ?? $this->load(__DIR__.'/getMessageRepositoryService.php'));
